...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
  ...
  <tr>
    ...
    <td><a href="jiaofeiupdt.php?roomID=<?php echo mysql_result($query,$i,"roomID");?>&i=<?php $i ?>&fare=<?php echo mysql_result($query,0,"fare");?>" style='color:#800080'>交费</a></td> 
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="jiaofeilist.php?pagecurrent=1">首页</a>, <a href="jiaofeilist.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiaofeilist.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiaofeilist.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
<p>&nbsp; </p>
