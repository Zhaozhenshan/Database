		...
		if($rowscount>0)
			...
			else
			{
				...
				$ndate =date("Y-m-d H:i:s");
					...
					echo "<script language='javascript'>alert('操作成功！');location.href='userManage.php';</script>";
			}
	 }
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    <tr>
    ...
    <tr>
      <td>权限:</td>
      <td><input name="cx" type="radio" value="协管员" checked="checked" />
      协管员
        <input type="radio" name="cx" value="管理员" />
      管理员
      <input type="radio" name="cx" value="教师" />
      教师</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
